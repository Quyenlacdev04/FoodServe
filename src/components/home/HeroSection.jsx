    ...
    <section className="relative w-full min-h-screen overflow-hidden bg-gradient-mesh noise-overlay transition-colors duration-500">
      ...
      <div className="absolute inset-0 z-0">
        <img
          ...
          alt="Food background"
          className="w-full h-full object-cover opacity-20 dark:opacity-15 mix-blend-overlay"
        />
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-white/50 to-white dark:via-dark-300/40 dark:to-dark-300 transition-colors duration-500" />
      </div>
      ...
      {/* Floating food cards with Ultra Premium Glassmorphism */}
      {/* 1. Burger Bò (Top Right) */}
      <motion.div
        className="absolute top-28 right-6 md:right-16 lg:right-28 glass-card rounded-3xl p-4 px-6 shadow-card-premium border-gradient hover:shadow-glow hover:border-primary-500/50 hidden md:flex items-center gap-4 transition-all duration-300 cursor-pointer select-none z-20"
      ...
      >
        ...
        <div className="flex flex-col items-start leading-tight">
          ...
          <p className="text-primary-500 font-sans font-black text-[14px] mt-0.5">
      ...
      {caps.showRestaurantManage ? (
        <Link to="/restaurant-manage" className="absolute bottom-28 right-6 md:right-16 lg:right-28 z-20 hidden md:block">
          <motion.div
            className="relative glass-card rounded-3xl p-4 px-6 shadow-card-premium border-gradient hover:shadow-glow hover:border-primary-500/50 flex items-center gap-4 transition-all duration-300 cursor-pointer select-none"
          ...
          >
            ...
            <div className="flex flex-col items-start leading-tight">
              ...
              <p className="text-primary-500 font-sans font-bold text-[13px] mt-0.5">Quản lý quán</p>
            </div>
          </motion.div>
        </Link>
        ...
        <Link to="/partner-register" className="absolute bottom-28 right-6 md:right-16 lg:right-28 z-20 hidden md:block">
          ...
          >
            ...
            <div className="flex flex-col items-start leading-tight">
              ...
              <p className="text-primary-500 font-sans font-bold text-[13px] mt-0.5">Hợp tác ngay!</p>
            </div>
          </motion.div>
        </Link>
      ) : null}
      ...
      {/* 3. Trà Sữa (Top Left) */}
      <motion.div
        className="absolute top-40 left-6 md:left-16 lg:left-28 glass-card rounded-3xl p-4 px-6 shadow-card-premium border-gradient hover:shadow-glow hover:border-primary-500/50 hidden lg:flex items-center gap-4 transition-all duration-300 cursor-pointer select-none z-20"
      ...
      <motion.div
        className="absolute top-72 left-6 md:left-16 lg:left-24 glass-card rounded-3xl p-4 px-6 shadow-card-premium border-gradient hover:shadow-glow hover:border-primary-500/50 hidden md:flex items-center gap-4 transition-all duration-300 cursor-pointer select-none z-20"
        ...
        <Link to="/driver" className="absolute bottom-16 left-6 md:left-16 lg:left-28 z-20 hidden md:block">
          ...
          >
            ...
            <div className="flex flex-col items-start leading-tight">
              ...
              <p className="text-primary-500 font-sans font-bold text-[13px] mt-0.5">Nhận đơn giao</p>
            </div>
          </motion.div>
        </Link>
        ...
        <Link to="/driver-register" className="absolute bottom-16 left-6 md:left-16 lg:left-28 z-20 hidden md:block">
          ...
          >
            ...
            <div className="flex flex-col items-start leading-tight">
              ...
              <p className="text-primary-500 font-sans font-bold text-[13px] mt-0.5">Thu nhập 90%!</p>
            </div>
          </motion.div>
        </Link>
      ) : null}

      {/* Hero content container: Centers content vertically & horizontally using flex */}
      <div className="relative z-10 min-h-screen w-full flex flex-col items-center justify-center text-center px-4 max-w-4xl mx-auto pt-24 pb-20">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full max-w-md mx-auto">
            <motion.a
              ...
              whileTap={{ scale: 0.97 }}
              className="btn-primary text-base px-8 py-4 flex items-center gap-2 shadow-glow-lg w-full sm:w-auto justify-center"
            >
              🍽️ Đặt món ngay
            </motion.a>
            <motion.a
              ...
              whileHover={{ scale: 1.03 }}
              whileTap={{ scale: 0.97 }}
              className="px-8 py-4 rounded-2xl text-base font-bold text-primary-500 border-2 border-primary-500/20 hover:border-primary-500/50 dark:border-white/10 dark:hover:border-white/20 bg-white/40 dark:bg-white/5 backdrop-blur-md transition-all shadow-sm w-full sm:w-auto justify-center"
            >
              📋 Xem menu
            </motion.a>
          </div>
        ...
        >
          {[
            ...
            <div key={s.label} className="text-center px-4 py-4 rounded-2xl bg-white/60 dark:bg-white/5 backdrop-blur-md border border-white/50 dark:border-white/5 shadow-card hover:shadow-glow transition-all duration-500 flex-1 min-w-[140px] max-w-[180px]">
